...
static int		build_pos(t_env *e, t_str *ptr)
{
	...
	if (o == 0)
		e->spheres->pos.x = ft_atof(secure_atof(ptr->str + 2));
	else if (o == 1)
		e->spheres->pos.y = ft_atof(secure_atof(ptr->str + 2));
	else if (o == 2)
		e->spheres->pos.z = ft_atof(secure_atof(ptr->str + 2));
	else
		error_yaml(ptr->str, YA_ERROR);
	o++;
	if (o == 3)
...
static int		build_rot(t_env *e, t_str *ptr)
{
	...
	if (ft_strlen(ptr->str) < 3 || ptr->str[0] != '-' || ptr->str[1] != ' ')
		error_yaml(ptr->str, YA_ERROR);
	if (o == 0)
		e->spheres->rot.x = ft_atof(secure_atof(ptr->str + 2));
	else if (o == 1)
		e->spheres->rot.y = ft_atof(secure_atof(ptr->str + 2));
	else if (o == 2)
		e->spheres->rot.z = ft_atof(secure_atof(ptr->str + 2));
	else
		error_yaml(ptr->str, YA_ERROR);
	o++;
	if (o == 3)
...
static int		build_color(t_env *e, t_str *ptr)
{
	...
	if (ft_strlen(ptr->str) < 3 || ptr->str[0] != '-' || ptr->str[1] != ' ')
		error_yaml(ptr->str, YA_ERROR);
	if (o == 0)
		e->spheres->color.x = (int)ft_atof(secure_atof(ptr->str + 2));
	else if (o == 1)
		e->spheres->color.y = (int)ft_atof(secure_atof(ptr->str + 2));
	else if (o == 2)
		e->spheres->color.z = (int)ft_atof(secure_atof(ptr->str + 2));
	else
		error_yaml(ptr->str, YA_ERROR);
	o++;
	if (o == 3)
...
static int		build_ray(t_env *e, t_str *ptr)
{
	...
	if ((sep = ft_strchr(ptr->str, YA_SEPARATOR)) == NULL || sep[1] != ' ')
		error_yaml(ptr->str, YA_ERROR);
	e->spheres->r = ft_atof(secure_atof(sep + 2));
	return (-1);
}
